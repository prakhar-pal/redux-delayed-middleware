...
export function getData(count = 200) {
    const data = []
    while (count--)
        data.push(new Person(count));
    return data;
}

export const generateName = () => namor.generate({ words: 2, saltLength: 0, separator: " ", subset: "manly" });

export const updateName = person => new Promise((resolve) => {
